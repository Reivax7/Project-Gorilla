...
public enum ModArmorMaterials implements ArmorMaterial {
    GORILLA_FUR("gorilla_fur", 26, new int[]{ 5, 7, 5, 4 }, 25,
            SoundEvents.ARMOR_EQUIP_LEATHER, 1f, 0f, () -> Ingredient.of(ModItems.GORILLA_FUR.get()));;
    ...
    public String getName() {
        return ProjectGorilla.MOD_ID + ":" + this.name;
    }
